...
MySQL - 10.1.36-MariaDB : Database - db_rumah_sakit
*********************************************************************
*/
...
CREATE TABLE `dokter` (
  ...
  `jenis_kelamin` enum('wanita','laki') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `id_poli` (`id_poli`),
  CONSTRAINT `dokter_ibfk_1` FOREIGN KEY (`id_poli`) REFERENCES `polis` (`id`)
...
CREATE TABLE `jadwals` (
  ...
  KEY `id_poli` (`id_poli`),
  CONSTRAINT `jadwals_ibfk_1` FOREIGN KEY (`id_dokter`) REFERENCES `dokter` (`id`),
  CONSTRAINT `jadwals_ibfk_2` FOREIGN KEY (`id_poli`) REFERENCES `polis` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(9,'2020_11_08_114722_create_dokter_table',2),
(10,'2020_11_08_114919_create_poli_table',2),
(11,'2020_11_08_114932_create_jadwal_table',2),
(12,'2020_11_08_114945_create_pendaftaran_table',2);
...
('09fa927c01178e6f6f26fd0daf2ee49d43540d51f6550536f11400faf6f26cfb996c954fd77ff040',8,1,'nApp','[]',0,'2020-12-23 05:32:03','2020-12-23 05:32:03','2021-12-23 05:32:03'),
...
('0c1507cba816e136b825fc86500f6e67fa9935439014bde6197e8bd47913625a842152e0fadc83fe',8,1,'nApp','[]',0,'2020-12-22 19:34:39','2020-12-22 19:34:39','2021-12-22 19:34:39'),
...
('28a2c59e7604f141839c9f441a72efd08f1bd6c3403931b3ae3c6d715118e411053f81ab94786fb3',9,1,'nApp','[]',0,'2021-01-07 17:21:34','2021-01-07 17:21:34','2022-01-07 17:21:34'),
...
('2f5e541c137a656fb96a952959da70f0ced9dadc10672603528ceca8a397cfa734c8f1b7811821eb',9,1,'nApp','[]',0,'2021-01-07 17:21:33','2021-01-07 17:21:33','2022-01-07 17:21:33'),
...
('62848e706c204380bffe3c5810bb49d34954b592d36eee3114d5b7b514a6cc25efd89df5ed7c7778',8,1,'nApp','[]',0,'2020-12-23 05:52:49','2020-12-23 05:52:49','2021-12-23 05:52:49'),
...
('71df6615d36f2a613ebd59a982737a634fac025a6a0409a21b83252d435e7c41250e2c9ec9fee1da',8,1,'nApp','[]',0,'2020-12-23 05:34:28','2020-12-23 05:34:28','2021-12-23 05:34:28'),
...
('7ecaa83c1c251941e8e4bebefe6797684645dc84fad1816101b52826d9f898149f46204d209e3911',7,1,'nApp','[]',0,'2020-12-21 11:43:52','2020-12-21 11:43:52','2021-12-21 11:43:52'),
...
('895eb75c4499449c53bf97b5add97970d1f5aa931659739ccad7a6febe6861301b933b188fd3ea1e',8,1,'nApp','[]',0,'2020-12-23 05:40:31','2020-12-23 05:40:31','2021-12-23 05:40:31'),
...
('8c2e72be34b34c3e2602b7e48d92d767db9c009932e6de63c058c1f2a34be0e524d3d7fb7e48cd0f',7,1,'nApp','[]',0,'2020-12-21 12:32:26','2020-12-21 12:32:26','2021-12-21 12:32:26'),
...
('a21511f0cda700c4f0679258db5e2c199904e3cdab143c1c4c9772ed3df45cdf08b395eaeab3de5c',4,1,'nApp','[]',0,'2020-11-15 10:44:54','2020-11-15 10:44:54','2021-11-15 10:44:54'),
...
('c370c974465752d8e551a127ed38aa5e9ee12b88d1625680af7fb35cd20f5637a4141f86997b7b06',4,1,'nApp','[]',0,'2020-11-12 18:45:14','2020-11-12 18:45:14','2021-11-12 18:45:14'),
...
('c98ca3ce9e2f5e4b1197fcd8294775dc056b6e790b6e8b74e746d81bfbfc46f357e5d643a92ff15c',4,1,'nApp','[]',0,'2020-11-11 09:43:12','2020-11-11 09:43:12','2021-11-11 09:43:12'),
...
('cb5fe0831fe518acc354776eb81dcbce009cc68a4931add4715a881ed47e0ded1f4ea70c4f1e3dfd',4,1,'nApp','[]',0,'2020-11-13 17:50:43','2020-11-13 17:50:43','2021-11-13 17:50:43'),
...
('f8e141f893d717a353211485f35c0aab997d8ffbdf330d387b978fb0df1cb788ad366f3c9d2ab84c',7,1,'nApp','[]',0,'2020-12-24 11:23:19','2020-12-24 11:23:19','2021-12-24 11:23:19'),
...
CREATE TABLE `pendaftarans` (
  ...
  `poli_tujuan` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tanggal_periksa` date DEFAULT NULL,
  `status_pendaftaran` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT 'terdaftar',
  ...
  KEY `id_user` (`id_user`),
  KEY `id_poli` (`id_poli`),
  CONSTRAINT `pendaftarans_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`),
  CONSTRAINT `pendaftarans_ibfk_2` FOREIGN KEY (`id_poli`) REFERENCES `polis` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `pendaftarans` */

insert  into `pendaftarans`(`id`,`id_user`,`id_poli`,`no_antrian`,`nama_user`,`tanggal_lahir`,`poli_tujuan`,`tanggal_periksa`,`status_pendaftaran`,`qrcode`,`created_at`,`updated_at`) values 
(50,5,2,1,'riri cantiks sekali','2020-11-10','Poli Mata','2020-11-15','terdaftar',NULL,'2020-11-27 16:37:40','2020-11-27 16:37:40'),
(51,5,2,2,'riri cantiks sekali','2020-11-10','Poli Mata','2020-11-15','terdaftar','5/2020-11-15/2','2020-11-27 16:43:41','2020-11-27 16:43:41'),
(52,5,2,3,'riri cantiks sekali','2020-11-10','Poli Mata','2020-11-15','terdaftar','5/2020-11-15/2','2020-11-27 16:45:52','2020-11-27 16:45:52'),
(53,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1','2020-11-27 18:53:26','2020-11-27 18:53:26'),
(54,4,1,2,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1','2020-11-27 18:57:07','2020-11-27 18:57:07'),
(55,4,1,3,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1','2020-11-27 19:13:47','2020-11-27 19:13:47'),
(56,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1','2020-11-27 19:14:35','2020-11-27 19:14:35'),
(57,4,1,2,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1','2020-11-27 19:20:52','2020-11-27 19:20:52'),
(58,4,1,4,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1','2020-11-27 19:23:29','2020-11-27 19:23:29'),
(59,4,1,5,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1','2020-11-27 19:24:24','2020-11-27 19:24:24'),
(60,4,1,3,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1/3','2020-11-27 19:38:39','2020-11-27 19:38:39'),
(61,4,1,6,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-28','terdaftar','4/2020-11-28/1/6','2020-11-27 19:39:00','2020-11-27 19:39:00'),
(62,4,1,4,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1/4','2020-11-28 05:12:24','2020-11-28 05:12:24'),
(63,4,1,5,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1/5','2020-11-28 05:13:42','2020-11-28 05:13:42'),
(64,4,1,6,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1/6','2020-11-28 05:18:33','2020-11-28 05:18:33'),
(65,4,1,7,'riri cantiks sekali','2020-11-10','Poli THT','2020-11-29','terdaftar','4/2020-11-29/1/7','2020-11-28 05:19:42','2020-11-28 05:19:42'),
(66,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2020-12-01','terdaftar','4/2020-12-01/1/1','2020-11-28 05:21:24','2020-11-28 05:21:24'),
(67,4,3,1,'riri cantiks sekali','2020-11-10','Poli Penyakit Dalam','2020-11-28','terdaftar','4/2020-11-28/3/1','2020-11-28 07:04:41','2020-11-28 07:04:41'),
(68,4,3,2,'riri cantiks sekali','2020-11-10','Poli Penyakit Dalam','2020-11-28','terdaftar','4/2020-11-28/3/2','2020-11-28 07:04:57','2020-11-28 07:04:57'),
(69,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2020-12-05','terdaftar','4/2020-12-05/1/1','2020-12-05 03:40:50','2020-12-05 03:40:50'),
(70,4,2,1,'riri cantiks sekali','2020-11-10','Poli Mata','2020-12-12','terdaftar','4/2020-12-12/2/1','2020-12-12 08:18:33','2020-12-12 08:18:33'),
(71,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2020-12-14','terdaftar','4/2020-12-14/1/1','2020-12-12 09:52:08','2020-12-12 09:52:08'),
(72,7,2,1,'Dyah Pradnya Wulandari','2000-12-25','Poli Mata','2020-12-23','terdaftar','7/2020-12-23/2/1','2020-12-21 11:52:34','2020-12-21 11:52:34'),
(73,7,4,1,'Dyah Pradnya Wulandari','2000-12-25','Poli Gigi dan Mulut','2020-12-23','terdaftar','7/2020-12-23/4/1','2020-12-21 12:16:43','2020-12-21 12:16:43'),
(74,8,1,1,'tes123','2020-12-23','Poli THT','2020-12-24','terdaftar','8/2020-12-24/1/1','2020-12-22 19:34:46','2020-12-22 19:34:46'),
(75,8,1,1,'tes123','2020-12-23','Poli THT',NULL,'terdaftar','8//1/1','2020-12-24 09:46:15','2020-12-24 09:46:15'),
(76,8,1,1,'tes123','2020-12-23','Poli THT','2020-12-25','terdaftar','8/2020-12-25/1/1','2020-12-24 10:01:13','2020-12-24 10:01:13'),
(77,8,1,2,'tes123','2020-12-23','Poli THT','2020-12-25','terdaftar','8/2020-12-25/1/2','2020-12-24 10:37:03','2020-12-24 10:37:03'),
(78,8,4,1,'tes123','2020-12-23','Poli Gigi dan Mulut','2020-12-26','terdaftar','8/2020-12-26/4/1','2020-12-24 10:41:42','2020-12-24 10:41:42'),
(79,8,1,1,'tes123','2020-12-23','Poli THT','2020-12-26','terdaftar','8/2020-12-26/1/1','2020-12-24 10:43:36','2020-12-24 10:43:36'),
(80,8,1,3,'AKURIRI','2020-12-23','Poli THT','2020-12-25','terdaftar','8/2020-12-25/1/3','2020-12-24 11:21:00','2020-12-24 11:21:00'),
(81,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2021-01-07','terdaftar','4/2021-01-07/1/1','2021-01-07 14:49:09','2021-01-07 14:49:09'),
(82,4,1,1,'riri cantiks sekali','2020-11-10','Poli THT','2021-01-16','terdaftar','4/2021-01-16/1/1','2021-01-07 14:49:36','2021-01-07 14:49:36'),
(83,9,1,1,'ryan timothy','2021-01-07','Poli THT','2021-01-27','terdaftar','9/2021-01-27/1/1','2021-01-07 17:22:05','2021-01-07 17:22:05'),
(84,9,1,1,'ryan timothy','2021-01-07','Poli THT','2021-01-14','terdaftar','9/2021-01-14/1/1','2021-01-07 17:28:52','2021-01-07 17:28:52');
...
CREATE TABLE `polis` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `nama_poli` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(1,'Poli THT',NULL,NULL),
(2,'Poli Mata',NULL,NULL),
(3,'Poli Penyakit Dalam',NULL,NULL),
(4,'Poli Gigi dan Mulut',NULL,NULL),
(5,'Poli Anak',NULL,NULL),
(6,'Poli Anastesi',NULL,NULL),
(7,'Poli Kejiwaan',NULL,NULL);
...
(4,'riri cantiks sekali','Laki-laki','2020-11-10','nambi agung','1231231231','riri9999','$2y$10$KeHrzy1ZQoziaJcVFeRdWONyDxZZ07SEg/C1Qhn8W0SB/zd9/sX6y',NULL,NULL,'2020-11-11 09:42:38','2020-11-11 09:42:38'),
(5,'riri cantiks sekali','Laki-laki','2020-11-10','nambi agung','1231231231','riri9999','$2y$10$WELS4O2uRV5sOkOyhH.tVe425UHD2HiY8SGvHTurmdiH93Ly00HLq',NULL,NULL,'2020-11-11 09:42:38','2020-11-11 09:42:38'),
(6,'wwwwsss','Perempuan','2020-11-14','qweqweqweqwe','1231230987','asdasdasd','$2y$10$elln0DxqEB3fRxTQ6xm.JOQwAFIUCsDvu6tmP7lOIrBAGpqZJMFrO',NULL,NULL,'2020-11-13 17:40:51','2020-11-13 17:40:51'),
(7,'Dyah Pradnya Wulandari','Perempuan','2000-12-25','Jalan Ubung','0857748775432','dyahpradnyaw','$2y$10$JV4aa.j/dmVyhy.uA7m2OuKFX067vb05USDifgJ/h7BiJT/Bxf/dq',NULL,NULL,'2020-12-21 11:42:47','2020-12-21 11:42:47'),
(8,'AKURIRI','Laki-laki','2020-12-23','Bali Indo','09878908766','tes123123','$2y$10$kKUJyu.cdVeIEiNOnMP3uO0Ndoo4dj68aoA7volAP1PfGYWEm8IVG',NULL,NULL,'2020-12-22 19:34:25','2020-12-24 11:20:41'),
(9,'ryan timothy','Laki-laki','2021-01-07','jimbaran','081122223333','ryan1234','$2y$10$Sn/Cppn337xQ20AwbH4JveoBr3CSjDw.p5ujvhbd1Rm9KKKJWi0DC',NULL,NULL,'2021-01-07 17:21:19','2021-01-07 17:21:19');
